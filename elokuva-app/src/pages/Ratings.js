...
export default function Ratings() {
  ...
  useEffect(() => {
    axios
      .post("/rating/ratedmoviedata", { data: ratingsList })
      .then((response) => {
              ...
              .map((movie, index) => (
                <div className="movieRatings" key={index}>
                  <img
                    ...
                    alt="Movie poster"
                    onClick={() =>
                      clickPick(movie.title ? movie.title : movie.name)
                    }
                  />
                  <div className="movieDetails">
                    <p>
                      ...
                      {movie.media_type === "movie" ? (
                        ...
                        movie.media_type === "tv" && <span>(tv-sarja)</span>
                      )}
                    </p>
                    <p>
                      ...
                      <span className="average">
                        (keskiarvo:{" "}
                        {averages[movie.title ? movie.title : movie.name]})
                      </span>
                    </p>
                    <p>
                      Käyttäjä{" "}
                      <span
                        className="raterName"
                        onClick={() => clickPick(movie.rater)}
                      >
                        <strong>{movie.rater}:</strong>
                      </span>
                    </p>
