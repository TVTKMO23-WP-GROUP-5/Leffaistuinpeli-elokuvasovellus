...
export default function Search() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log(
          JSON.stringify(response.data[8]),
          JSON.stringify(response.data[9]),
          JSON.stringify(response.data[10])
        );
  ...
  const handleFilteredSearch = (event, name, value) => {
    ...
    axios
      .post("/movies/filtered", searchData)
      .then((response) => {
    ...
    <>
      ...
      >
        <div className="search-type">
          ...
          />
          <span class="radio-label">Nimihaku</span>
          <input
            type="radio"
            name="searchType"
            className="searchInput"
            ...
            onClick={handleSearchType}
          />
          <span class="radio-label">Tarkempi elokuvahaku</span>
          <input
            type="radio"
            name="searchType"
            className="searchInput"
            ...
            onClick={handleSearchType}
          />
          <span class="radio-label">Tarkempi sarjahaku</span>
        </div>
            ...
            <form className="filtered-search" onSubmit={handleFilteredSearch}>
              <div>
                <select
                  ...
                  onChange={(e) => {
                    handleFilter(e);
                    handleFilteredSearch(e, e.target.name, e.target.value);
                  }}
                >
            ...
            <form className="filtered-search" onSubmit={handleFilteredSeries}>
              <div>
                <select
                  ...
                  onChange={(e) => {
                    handleFilter(e);
                    handleFilteredSeries(e, e.target.name, e.target.value);
                  }}
                >
                  <option value="">Genre</option>
        ...
        <div className="changePage-search">
          ...
          {moviePick && endIndex < moviePick.length && (
            <div className="searchNext">
              <button className="searchButton" onClick={handleClickNext}>
                Seuraava
              </button>
            </div>
          )}
