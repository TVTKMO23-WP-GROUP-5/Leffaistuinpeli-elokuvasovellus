          ...
          <div className="user-container">
            ...
            {user && (
              <div className="user-content">
                ...
                <p><strong>Käyttäjätunnus:</strong><span>{userinfo.username}</span></p>
                  <p><strong>Etunimi:</strong><span>{userinfo.fname}</span></p> 
                  <p><strong>Sukunimi:</strong><span>{userinfo.lname}</span></p>
                  <p><strong>Sähköposti:</strong><span>{userinfo.email}</span></p>
                </div>
