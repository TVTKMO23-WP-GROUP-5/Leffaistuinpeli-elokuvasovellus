...
router.post("/register", async (req, res) => {
  ...
  try {
    ...
    if (!groupname || !description) {
      return res
        .status(400)
        .json({ success: false, message: "Ryhmän nimi ja kuvaus vaaditaan" });
    }
    ...
    res
      .status(500)
      .json({ success: false, message: "Ryhmän luonti epäonnistui" });
  }
});
